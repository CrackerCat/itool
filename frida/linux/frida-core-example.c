 ...
 * Compile with:
 *
 * gcc -fPIC -ffunction-sections -fdata-sections -m64 frida-core-example.c -o frida-core-example -L. -lfrida-core -ldl -lm -latomic -lrt -lresolv -pthread -fuse-ld=gold -Wl,--export-dynamic,--icf=all,--gc-sections,-z,noexecstack -static-libgcc
 *
